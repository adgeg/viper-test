# Clean Login
A *clean* implementation of a login use-case, following [recommandations of Uncle Bob] (https://8thlight.com/blog/uncle-bob/2012/08/13/the-clean-architecture.html):
...
* Independant of UI : core module is a Java module, **without any reference to Android**
